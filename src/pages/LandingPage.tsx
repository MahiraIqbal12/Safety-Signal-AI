...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="max-w-7xl mx-auto px-6 py-24 text-center animate-fade-in">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-foreground text-center mb-10">What Safety Signal AI Does</h2>
